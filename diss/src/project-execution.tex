...
library to build a command line interface in a declarative fashion. This made
it easy to visually see the subcommands and options that I had defined and to
document them in the same place.
\todo{Defo Maybe example of declarative nature of clap arg parsing?}
